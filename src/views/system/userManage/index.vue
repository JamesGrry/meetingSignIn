<template>
  <div id="userManage">
    ...
    <!-- 新增用户和编辑用户start -->
    <el-dialog
      :title="dialogUserModify.dialogTitle"
      :visible.sync="dialogUserModify.dialogYnc"
    ...
    >
      <div>
        ...
        >
          ...
          <el-form-item
            v-if="dialogUserModify.dialogIsAddUser==true"
            class="formInput"
            label="角色权限"
          >
            <el-select v-model="userInfo.role" placeholder="请选择">
              <el-option
                ...
                :key="item.authorityCorresponding"
                :label="item.authorityNotes"
                :value="item.authorityCorresponding"
              ></el-option>
            </el-select>
          </el-form-item>
